...
body {
  display: block !important;
        ...
        .angry-grid a.active {
            padding: 0 3px;
            box-shadow: 0 0 2px #0f9b0f, 0 0 10px #0f9b0f, 0 0 15px #0f9b0f, 0 0 20px #0f9b0f, 0 0 25px #0f9b0f, 0 0 30px #0f9b0f, 0 0 35px #0f9b0f;
        }
...
.title-worm-turkiye {
  display: flex;
  align-items: center;
  /* text-shadow: 0 0 0 #e50f0f, 0 0 0.5em #f10b0b, 0 0 0.4em #f3eded; */
  color: #fff;
  text-align: center;
  justify-content: center;
  font-weight: 700;
...
#game-wrap
  ...
  #main-menu-view
  #mm-line-top
  #mm-player-info:hover {
    box-shadow: 0 0 5px #0f9b0f, 0 0 10px #0f9b0f, 0 0 15px #0f9b0f, 0 0 20px #0f9b0f, 0 0 25px #0f9b0f, 0 0 30px #0f9b0f, 0 0 35px #0f9b0f;
}
...
#game-wrap
  ...
  background: #104c3c;
  border-radius: 20px;
 box-shadow: 0px 0px 5px 2px #0f9b0f;
}
...
@keyframes flicker {
  ...
  57%,
  100% {
    box-shadow: 0 0 4px #0f9b0f, 0 0 11px #0f9b0f, 0 0 19px #0f9b0f,
      0 0 40px #0f9b0f, 0 0 80px #0f9b0f, 0 0 90px #0f9b0f, 0 0 100px #0f9b0f,
      0 0 150px #0f9b0f;
  }
  20%,
  24%,
...
#game-wrap
  ...
  #mm-line-center
  .column-left
  .description-text:nth-child(n + 2) {
  display: none;
}
...
#game-wrap
  ...
  .mm-skin {
    height: 70px;
    position: relative;
     background-image: url("https://app2.wormateturkiye.com/public/img/bg_4.png");
  background-repeat: no-repeat;
  background-size: cover;
    padding: 0 10px;
    border-radius: 10px;
...
#game-wrap
  ...
  width: 300px;
  right: 0px;
  background-image: url("https://app2.wormateturkiye.com/public/img/sm.gif");
...
.tab-pane > div {
  ...
  display: flex;
  align-items: center;
  box-shadow: 0px 0px 2px 1px #0f9b0f;
  padding: 5px 0;
}
...
#game-wrap
  ...
  .popup-view-list
  #coins-view
  .store-coins-unavailable {
  position: absolute;
  height: 100%;
  width: 100%;
  border-radius: 4px;
  background: rgba(47, 46, 68, 0.95);
}
...
#game-wrap
  ...
  #popup-view
  .popup-view-list
  #withdraw-consent-view
  .withdraw-consent-question {
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
#game-wrap
  ...
  #toaster-stack
  .toaster-consent-accepted
  .toaster-consent-accepted-container {
  position: absolute;
  top: 100px;
  left: 20px;
  right: 20px;
...
#game-wrap
  #game-cont
  #stretch-box
  #error-gateway-connection-view
  #error-gateway-connection-wrap {
  background: #fff;
  display: block;
  position: absolute;
  top: 60px;
...
#game-wrap
  ...
  #error-gateway-connection-view
  #error-gateway-connection-wrap
  #error-gateway-connection-caption {
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
#game-wrap
  ...
  #error-gateway-connection-view
  #error-gateway-connection-wrap
  #error-gateway-connection-message {
  display: table;
  position: absolute;
  top: 75px;
  height: 205px;
...
#game-wrap
  ...
  #error-gateway-connection-wrap
  #error-gateway-connection-message
  #error-gateway-connection-message-text {
  color: #000;
  font-size: 20px;
  display: table-cell;
  vertical-align: middle;
...
#game-wrap
  ...
  #error-gateway-connection-view
  #error-gateway-connection-wrap
  #error-gateway-connection-retry {
  background-color: #26c6da;
  color: #fff;
  overflow: hidden;
  height: 50px;
...
#game-wrap
  ...
  #error-gateway-connection-view
  #error-gateway-connection-wrap
  #error-gateway-connection-retry:hover {
  box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.5);
  background-color: #52d1e1;
}
...
#game-wrap
  ...
  #error-gateway-connection-view
  #error-gateway-connection-wrap
  #error-gateway-connection-retry:focus {
  outline: 0;
}
...
#game-wrap
  #game-cont
  #stretch-box
  #error-game-connection-view
  #error-game-connection-wrap {
  background: #fff;
  display: block;
  position: absolute;
  top: 60px;
...
#game-wrap
  ...
  #error-game-connection-wrap
  #error-game-connection-message
  #error-game-connection-message-text {
  color: #000;
  font-size: 20px;
  display: table-cell;
  vertical-align: middle;
...
#game-wrap
  ...
  #error-game-connection-view
  #error-game-connection-wrap
  #error-game-connection-retry:hover {
  box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.5);
  background-color: #52d1e1;
}
...
#game-wrap
  ...
  #error-game-connection-view
  #error-game-connection-wrap
  #error-game-connection-retry:focus {
  outline: 0;
}
...
#game-wrap #game-cont #results-view #congrats-bg #congrats-wrap #congrats {
  ...
  height: 415px;
  background-color: #fff;
  box-shadow: 0 0 200px 100px rgba(34, 34, 34, 0.8);
  border-radius: 8px;
  overflow: hidden;
}
...
#game-wrap
  ...
  #congrats
  .controls
  #final-continue:hover {
    background:#fff;
    color:red;
  box-shadow: 0 0 3px #0f9b0f, 0 0 5px #0f9b0f, 0 0 10px #0f9b0f, 0 0 15px #0f9b0f, 0 0 20px #0f9b0f, 0 0 35px #0f9b0f, 0 0 30px #0f9b0f;
}
...
#game-wrap #game-cont #results-view #unl6wj4czdl84o9b {
  ...
  background: rgba(0, 0, 0, 0.25);
  border-radius: 8px;
  box-shadow: 0 0 40px 0 rgba(34, 34, 34, 0.8);
}
